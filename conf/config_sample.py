...
CENTRAL_WALLET = 'enter_valid_address'	# local coin address where money goes

COINDAEMON_TRUSTED_HOST = 'localhost'
COINDAEMON_TRUSTED_PORT = 7745
...
LOGFILE = 'stratum-maru.log'		# eg. 'stratum.log'
...
DB_MYSQL_USER = 'pooldb_user'
DB_MYSQL_PASS = 'pooldb_pass'
...
POOL_TARGET = 0.00390625                        # Pool-wide difficulty target int >= 1
...
VDIFF_MIN_TARGET = 0.00390625                #  Minimum Target difficulty 
...
INVALID_SHARES_PERCENT = 75    # Allow average invalid shares vary this % before we ban
